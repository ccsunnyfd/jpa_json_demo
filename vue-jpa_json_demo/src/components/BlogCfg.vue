  ...
  <el-card style="width: 500px" v-loading="loading">
    <div>
      <div style="text-align: left">
        <el-form :model="emailValidateForm" label-position="top" ref="emailValidateForm" style="color:#20a0ff;font-size: 14px;">
          <el-form-item prop="email" label="开启博客评论通知" :rules="[{type: 'email', message: '邮箱格式不对哦!'}]">
            <el-input type="email" v-model="emailValidateForm.email" auto-complete="off" style="width: 300px" placeholder="请输入邮箱地址..." size="mini"></el-input>
